...
const Savedlocation = () => {
  ...
  return (
    ...
    <View style={styles.savedDestination07View}>
        ...
        <View style={styles.modalView}>
          ...
          <View style={[styles.contentView10, styles.mt32]}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/SavedDestionation/image1.png")}
            />
            <View style={[styles.textSupportingText, styles.mt16]}>
              <Text style={styles.text8}>Location Confimation</Text>
          ...
          <View style={[styles.modalActionComponent, styles.mt32]}>
            ...
            >
              <View style={styles.buttonBasePrimaryView1}>
                <Text style={styles.text9}>Yes, Add Now</Text>
              </View>
            </Pressable>
            <Pressable
              style={[styles.buttonPressable1, styles.mt12]}
              onPress={() => navigation.navigate("Addresspage")}
            >
              <View style={styles.buttonBasePrimaryView2}>
                <Text style={styles.text10}>No, But Add Anyways</Text>
              </View>
            </Pressable>
          </View>
          {/* <Image
