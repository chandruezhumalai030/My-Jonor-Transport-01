    ...
    <View style={styles.Modal}>
      ...
      <View style={styles.Content}>
        <View style={styles.TextSupportingText}>
          <Text style={styles.Txt769}>Congratulations</Text>
          <Text style={styles.Txt224}>Your account is ready to use. You will be redirected to the Home page in a few seconds..</Text>
        </View>
      </View>
      <View style={styles._modalActionComponent}>
         <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate("ForgetReset")}>
